  ...
  function App() {
    ...
    React.useEffect(() => {
      ...
      const statsChart = new Chart(statsCtx, {
        type: 'doughnut',
        data: {
          labels: ['Başarılı', 'Başarısız', 'Atlanan'],
          datasets: [{
            data: [0, 0, 0],
      ...
      socket.on('profile_validation', (data) => {
        if (data.success) {
      ...
      return () => {
        ...
        socket.off('profile_validation');
      };
    }, []); // <-- Burada bağımlılık dizisini boş bıraktık, böylece useEffect sadece bileşen ilk yüklendiğinde çalışır.
  
    // maxPages değiştiğinde sadece progress bar'ı güncellemek istiyorsanız, ayrı bir useEffect kullanabilirsiniz.
    React.useEffect(() => {
          ...
          <TabPanel value={tabValue} index={0}>
            <div className="grid-container">
              ...
              <Paper className="paper">
                ...
                <Typography>Tarana Sayfa: {pagesCrawled}</Typography>
